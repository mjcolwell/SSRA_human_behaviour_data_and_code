...
library(TOSTER)
#Checking between-groups equivalence for outcome sensitivity during reward trials
TOSTtwo(m1=2.606,m2=2.507,sd1=1.605,sd2=1.642,n1=26,n2=27,low_eqbound=-0.69, high_eqbound=0.69, alpha = 0.05, var.equal=TRUE)
