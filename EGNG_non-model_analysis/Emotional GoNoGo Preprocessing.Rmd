...
Boxplot_criterion_all <- MasterGNGwideAlt2Post %>% ggplot(aes(x = Allocation, y = beta, fill = Allocation)) +
  ...
  labs(title = " ") +
  ylab("Log decision criterion (β) - Overall\n\n") +
  xlab("") +
  theme_minimal() +
  theme(legend.position = "none", text = element_text(size = 14), axis.title = element_text(size = 16), strip.text = element_blank(), plot.margin = margin(t = 0, r = -20, l = 0, b = 0)) +
  stat_boxplot(
...
TOSTtwo(m1=48.385,m2=47.704,sd1=13.423,sd2=11.374,n1=26,n2=27,low_eqbound=-0.7, high_eqbound=0.7, alpha = 0.05, var.equal=TRUE)

#Checking between-groups equivalence for response times during reward trials
TOSTtwo(m1=856.013,m2=842.04,sd1=257.478,sd2=267.344,n1=26,n2=27,low_eqbound=-0.7, high_eqbound=0.7, alpha = 0.05, var.equal=TRUE)
